...
clf = pickle.load(open("RandomForestClf1.pkl", "rb"))
...
# 1. import Model
#clf = pickle.load(open("RandomForestClf.pkl", "rb"))
...
def execute(img, src, t):
    ...
    for i in range(counts[0]):
        keypoints, kplist = get_keypoint(objects, i, peaks)
        ...
        print(results)
        print(resultsP)
        if resultsP[0][results] > 0.6:
            cv2.putText(src, "pos: " + str(results), (20, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 1)
